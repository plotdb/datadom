...
(function(){
  var json0, samplePlugin, wrap, serialize, deserialize, locate, main;
  if ((typeof module != 'undefined' && module !== null) && (typeof require != 'undefined' && require !== null)) {
    json0 = require('@plotdb/json0');
  }
  samplePlugin = function(arg$){
    var data, window, node, promise;
    data = arg$.data, window = arg$.window;
  ...
  main.prototype = import$(Object.create(Object.prototype), {
    ...
    init: function(){
      ...
      if (this.node) {
        return Promise.resolve().then(function(){
          return this$.data = serialize(this$.node, this$.plugins.length ? function(o){
            return this$.plugin(o);
          } : null);
        });
      } else {
        return deserialize(this.data, this.plugins.length ? function(o){
          return this$.plugin(o);
        } : null, this.window).then(function(arg$){
          var node, promise;
          node = arg$.node, promise = arg$.promise;
          this$.node = node;
          return promise;
