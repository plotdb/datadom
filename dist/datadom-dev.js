...
(function(){
  var json0, wrap, serialize, serializeGeneral, serializeRecurse, serializePlugin, deserialize, locate, main;
  ...
  serializeGeneral = function(n){
    var name, style, i, attr, v, cls, node;
    name = n.nodeName.toLowerCase();
    if (name === '#text') {
      return {
        type: 'text',
  ...
  serializeRecurse = function(n, plugin){
    var node, child, i$, to$, i, ret;
    if (isBlock(n)) {
      node = serializePlugin(n, plugin);
    } else {
      node = serializeGeneral(n);
    }
    child = [];
    if (!n.childNodes) {
      return;
  ...
  serializePlugin = function(n, plugin){};
  /**
   ...
   */
  deserialize = function(n, plugin, win){
    var doc, queue;
    win == null && (win = window);
    doc = win.document;
    queue = [];
    return Promise.resolve().then(function(){
      var _;
      _ = function(n){
        var node, i$, ref$, len$, c, ret, plugs, promise, t;
        switch (n.type) {
        case 'text':
        ...
        default:
          ...
          plugs = [];
          for (i$ = 0, len$ = (ref$ = n.plugs || []).length; i$ < len$; ++i$) {
            c = ref$[i$];
            plugs.push(_(c));
          }
          if (!plugin) {
          ...
          if (!ret) {
            ...
            ref$ = ret || {}, node = ref$.node, promise = ref$.promise;
          }
          if (promise) {
            queue.push(promise);
          }
  ...
  main.prototype = import$(Object.create(Object.prototype), {
    ...
    init: function(){
      ...
      if (this.node) {
        return Promise.resolve().then(function(){
          return this$.data = serialize(this$.node, function(o){
            return this$.plugin(o);
          });
        });
      } else {
        return deserialize(this.data, function(o){
          return this$.plugin(o);
        }, this.window).then(function(arg$){
          var node, promise;
          node = arg$.node, promise = arg$.promise;
          this$.node = node;
          return {
